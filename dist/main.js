...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n    margin: 0;\n}\n\n#container {\n    display: grid;\n    grid-template-columns: 1fr 5fr;\n    height: 100vh;\n}\n\n#content {\n    grid-column: 2/-1;\n    background-color: grey;\n}", "",{"version":3,"sources":["webpack://./src/styles/index.css"],"names":[],"mappings":"AAAA;IACI,SAAS;AACb;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,aAAa;AACjB;;AAEA;IACI,iBAAiB;IACjB,sBAAsB;AAC1B","sourcesContent":["* {\n    margin: 0;\n}\n\n#container {\n    display: grid;\n    grid-template-columns: 1fr 5fr;\n    height: 100vh;\n}\n\n#content {\n    grid-column: 2/-1;\n    background-color: grey;\n}"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#sidebar {\n    grid-column: 1/2;\n    grid-row: 1/-1;\n    background-color: rgb(170, 255, 43);\n    font-size: 2rem;\n    padding: 16px;\n    display: grid;\n    grid-template-rows: 7fr 1fr;\n\n    justify-items: center;\n}\n\n#side-bar-items {\n    display: grid;\n}\n\n#sidebar .sidebar-add-button {\n    margin: 10px;\n    width: 100px;\n    height: 40px;\n    background-color: rgb(255, 255, 255);\n    font-size: 1.2rem;\n    border-radius: 20px;\n    font-weight: 700;\n    cursor: pointer;\n}\n\n#sidebar .sidebar-add-button:hover {\n    background-color: rgb(10, 78, 10);\n    color: white;\n    font-weight: 900;\n}\n\n#sidebar .sidebar-add-button:active {\n    color: rgb(187, 159, 0);\n}\n\n#sidebar form {\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    font-size: 2rem;\n}\n\n#sidebar form input {\n    border-radius: 10px;\n    padding: 5px;\n    margin: 5px;\n}\n\n#sidebar form input:focus {\n    border: 4px solid rgba(159, 95, 0, 0.891);\n}", "",{"version":3,"sources":["webpack://./src/styles/sidebar.css"],"names":[],"mappings":"AAAA;IACI,gBAAgB;IAChB,cAAc;IACd,mCAAmC;IACnC,eAAe;IACf,aAAa;IACb,aAAa;IACb,2BAA2B;;IAE3B,qBAAqB;AACzB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,oCAAoC;IACpC,iBAAiB;IACjB,mBAAmB;IACnB,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,iCAAiC;IACjC,YAAY;IACZ,gBAAgB;AACpB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,eAAe;AACnB;;AAEA;IACI,mBAAmB;IACnB,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,yCAAyC;AAC7C","sourcesContent":["#sidebar {\n    grid-column: 1/2;\n    grid-row: 1/-1;\n    background-color: rgb(170, 255, 43);\n    font-size: 2rem;\n    padding: 16px;\n    display: grid;\n    grid-template-rows: 7fr 1fr;\n\n    justify-items: center;\n}\n\n#side-bar-items {\n    display: grid;\n}\n\n#sidebar .sidebar-add-button {\n    margin: 10px;\n    width: 100px;\n    height: 40px;\n    background-color: rgb(255, 255, 255);\n    font-size: 1.2rem;\n    border-radius: 20px;\n    font-weight: 700;\n    cursor: pointer;\n}\n\n#sidebar .sidebar-add-button:hover {\n    background-color: rgb(10, 78, 10);\n    color: white;\n    font-weight: 900;\n}\n\n#sidebar .sidebar-add-button:active {\n    color: rgb(187, 159, 0);\n}\n\n#sidebar form {\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    font-size: 2rem;\n}\n\n#sidebar form input {\n    border-radius: 10px;\n    padding: 5px;\n    margin: 5px;\n}\n\n#sidebar form input:focus {\n    border: 4px solid rgba(159, 95, 0, 0.891);\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _get_user_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./get-user-input */ "./src/modules/get-user-input.js");
