...
const addToDoButton = () => {
    const addToDoButton = (0,_page_layout__WEBPACK_IMPORTED_MODULE_0__.addButton)(contentItems, '+ To Do', 'to-do', 'button');
    (0,_user_input__WEBPACK_IMPORTED_MODULE_1__.registerAddToDoListener)(addToDoButton);
};
