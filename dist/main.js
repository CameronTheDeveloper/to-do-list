...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#content {\n    display: grid;\n}\n\n#content-items {\n    display: grid;\n    grid-template: repeat(5, 1fr) / repeat(5, 1fr);\n}\n\n#content-items {\n    display: grid;\n    margin: 16px;\n    padding: 16px;\n}\n\n/* To Do Form */\n\n#todo-add-form form {\n    background-color: white;\n    padding: 8px;\n    border-radius: 16px;\n\n}\n\n#todo-add-form input,\n#todo-add-form textarea {\n    width: 350px;\n    font-size: 1rem;\n    border: 1px solid green;\n    padding: 4px;\n}\n\n#todo-add-form button {\n    border-radius: 12px;\n}\n\n/* To Do */\n\n.todo {\n    background-color: white;\n    padding: 16px;\n    margin: 16px;\n    border-radius: 16px;\n}\n\n.todo .title {\n    font-weight: bold;\n    font-size: 2rem;\n}", "",{"version":3,"sources":["webpack://./src/styles/to-do.css"],"names":[],"mappings":"AAAA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,8CAA8C;AAClD;;AAEA;IACI,aAAa;IACb,YAAY;IACZ,aAAa;AACjB;;AAEA,eAAe;;AAEf;IACI,uBAAuB;IACvB,YAAY;IACZ,mBAAmB;;AAEvB;;AAEA;;IAEI,YAAY;IACZ,eAAe;IACf,uBAAuB;IACvB,YAAY;AAChB;;AAEA;IACI,mBAAmB;AACvB;;AAEA,UAAU;;AAEV;IACI,uBAAuB;IACvB,aAAa;IACb,YAAY;IACZ,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;IACjB,eAAe;AACnB","sourcesContent":["#content {\n    display: grid;\n}\n\n#content-items {\n    display: grid;\n    grid-template: repeat(5, 1fr) / repeat(5, 1fr);\n}\n\n#content-items {\n    display: grid;\n    margin: 16px;\n    padding: 16px;\n}\n\n/* To Do Form */\n\n#todo-add-form form {\n    background-color: white;\n    padding: 8px;\n    border-radius: 16px;\n\n}\n\n#todo-add-form input,\n#todo-add-form textarea {\n    width: 350px;\n    font-size: 1rem;\n    border: 1px solid green;\n    padding: 4px;\n}\n\n#todo-add-form button {\n    border-radius: 12px;\n}\n\n/* To Do */\n\n.todo {\n    background-color: white;\n    padding: 16px;\n    margin: 16px;\n    border-radius: 16px;\n}\n\n.todo .title {\n    font-weight: bold;\n    font-size: 2rem;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
