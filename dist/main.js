...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#todo-clear-mode-button.inactive {\n    width: 175px;\n    font-size: 1.2rem;\n    border-radius: 12px;\n    height: 58px;\n    margin: 12px;\n    background-color: rgb(255, 255, 255);\n    font-weight: 500;\n\n    transition: box-shadow 50ms ease-in,\n        font-weight 50ms ease-in,\n        font-size 50ms ease-in,\n        color 50ms ease-in;\n}\n\n#todo-clear-mode-button.active {\n    color: red;\n    font-size: 1.4rem;\n    font-weight: 900;\n    box-shadow: 0 0 10px red;\n\n    width: 175px;\n    border-radius: 12px;\n    height: 58px;\n    margin: 12px;\n    background-color: rgb(255, 198, 198);\n}\n\n#todo-clear-mode-button:hover {\n    background-color: rgb(255, 171, 171);\n}\n\n.todo.expand-mode:hover {\n    background-color: rgb(24, 244, 24);\n    transition: background-color 0.15s ease-in-out;\n}", "",{"version":3,"sources":["webpack://./src/styles/to-do-mode.css"],"names":[],"mappings":"AAAA;IACI,YAAY;IACZ,iBAAiB;IACjB,mBAAmB;IACnB,YAAY;IACZ,YAAY;IACZ,oCAAoC;IACpC,gBAAgB;;IAEhB;;;0BAGsB;AAC1B;;AAEA;IACI,UAAU;IACV,iBAAiB;IACjB,gBAAgB;IAChB,wBAAwB;;IAExB,YAAY;IACZ,mBAAmB;IACnB,YAAY;IACZ,YAAY;IACZ,oCAAoC;AACxC;;AAEA;IACI,oCAAoC;AACxC;;AAEA;IACI,kCAAkC;IAClC,8CAA8C;AAClD","sourcesContent":["#todo-clear-mode-button.inactive {\n    width: 175px;\n    font-size: 1.2rem;\n    border-radius: 12px;\n    height: 58px;\n    margin: 12px;\n    background-color: rgb(255, 255, 255);\n    font-weight: 500;\n\n    transition: box-shadow 50ms ease-in,\n        font-weight 50ms ease-in,\n        font-size 50ms ease-in,\n        color 50ms ease-in;\n}\n\n#todo-clear-mode-button.active {\n    color: red;\n    font-size: 1.4rem;\n    font-weight: 900;\n    box-shadow: 0 0 10px red;\n\n    width: 175px;\n    border-radius: 12px;\n    height: 58px;\n    margin: 12px;\n    background-color: rgb(255, 198, 198);\n}\n\n#todo-clear-mode-button:hover {\n    background-color: rgb(255, 171, 171);\n}\n\n.todo.expand-mode:hover {\n    background-color: rgb(24, 244, 24);\n    transition: background-color 0.15s ease-in-out;\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
